...
{
    public class CommonReassignmentRuleEngine : IReassignmentRuleEngine
    {
        private static readonly List<UserId> ValidApprovers = new List<UserId>
        {
            new UserId("approver1"),
            new UserId("approver2"),
            new UserId("approver3"),
            new UserId("approver4"),
            new UserId("approver5"),
            new UserId("SeniorAdminApprover")
        };
        ...
        public UserId? DetermineReassignment(GenericApprovalPayload genericPayload, UserId currentApprover, UserId proposedNewAssignedTo)
        {
